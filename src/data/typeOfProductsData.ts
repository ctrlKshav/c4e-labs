...
export const productTypes = [
  {
    ...
    icon: (className = "h-12 w-12 text-blue-600") => React.createElement(Cloud, { className }),
  ...
  },
  {
    ...
    icon: (className = "h-12 w-12 text-green-500") => React.createElement(ShoppingBag, { className }),
    color: "bg-white/30",
  },
  {
    id: "others",
    ...
    icon: (className = "h-12 w-12 text-gray-600") => React.createElement(Package, { className }),
